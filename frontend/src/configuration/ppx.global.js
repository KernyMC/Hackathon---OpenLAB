// Configuración global que evita DataCloneError usando callback global
let data = {
  ...
  // SIN onAuthorize - Se maneja globalmente
};

// Callback global que evita DataCloneError
window.pluxPaymentCallback = function(response) {
